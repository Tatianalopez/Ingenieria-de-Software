        ...
        try {
            ...
            if ("ok5".equals(validarR)) {
                ...
                if (this.Cotizacion == true) {
                    PreRad.InserPreRadicacion(1, 0, mBAdmi.Adm.getCodTipProEnt(), 1, mBsesion.codigoMiSesion());
                } else if (Cotizacion == false) {
                    PreRad.InserPreRadicacion(1, 0, mBAdmi.Adm.getCodTipProEnt(), 0, mBsesion.codigoMiSesion());
                }
    ...
    public void inserPreRadicacion(int proceso) {
        try {
            ...
            if ("ok1".equals(validar1)) {
                ...
                PreRad.setCod_Analista(Integer.parseInt(CodAnalista));
                if (this.Cotizacion == true) {
                    PreRad.InserPreRadicacion(2, Integer.parseInt(cod_preRadica), mBAdmi.Adm.getCodTipProEnt(), 1, mBsesion.codigoMiSesion());
                } else if (Cotizacion == false) {
                    PreRad.InserPreRadicacion(2, Integer.parseInt(cod_preRadica), mBAdmi.Adm.getCodTipProEnt(), 0, mBsesion.codigoMiSesion());
                }
                ...
                if (mBArchivo.getSeleccionArc().size() > 0) {
                    ...
                    for (int i = 0; i <= mBArchivo.getSeleccionArc().size() - 1; i++) {
                        ...
                        PreRad.InserOModifArchivosPreRad(Integer.parseInt(cod_preRadica), Integer.parseInt(cod_tipArchivo));
                    }
                }

                switch (mBAvaluo.getCodTipAvaluo()) {
                    case 1:
                        break;
                    case 2:
                        break;
                ...
                if (mBEntidad.isEstPanelEntidad() == true) {
                    ...
                    if (mBEntidad.isEntidadFact1() == true && !"".equals(mBEntidad.getCodAsesor1())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor1()), "T", mBsesion.codigoMiSesion());
                    } else if (mBEntidad.isEntidadFact1() == false && !"".equals(mBEntidad.getCodAsesor1())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor1()), "S", mBsesion.codigoMiSesion());
                    }
                    if (mBEntidad.isEntidadFact2() == true && !"".equals(mBEntidad.getCodAsesor2())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor2()), "T", mBsesion.codigoMiSesion());
                    } else if (mBEntidad.isEntidadFact2() == false && !"".equals(mBEntidad.getCodAsesor2())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor2()), "S", mBsesion.codigoMiSesion());
                    }
                    if (mBEntidad.isEntidadFact3() == true && !"".equals(mBEntidad.getCodAsesor3())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor3()), "T", mBsesion.codigoMiSesion());
                    } else if (mBEntidad.isEntidadFact3() == false && !"".equals(mBEntidad.getCodAsesor3())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor3()), "S", mBsesion.codigoMiSesion());
                    }
                    if (mBEntidad.isEntidadFact4() == true && !"".equals(mBEntidad.getCodAsesor4())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor4()), "T", mBsesion.codigoMiSesion());
                    } else if (mBEntidad.isEntidadFact4() == false && !"".equals(mBEntidad.getCodAsesor4())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor4()), "S", mBsesion.codigoMiSesion());
                    }
                    if (mBEntidad.isEntidadFact5() == true && !"".equals(mBEntidad.getCodAsesor5())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor5()), "T", mBsesion.codigoMiSesion());
                    } else if (mBEntidad.isEntidadFact5() == false && !"".equals(mBEntidad.getCodAsesor5())) {
                        PreRad.InsertOModificEntidadPreRadica(proceso, Integer.parseInt(mBEntidad.getCodAsesor5()), "S", mBsesion.codigoMiSesion());
                    }
                }
...
//            this.radioPersona = true;
     ...
     * @since 01-11-2014
     */
    public void generarEstudio(ActionEvent event) {
        try {
            ...
            if ("Si".equals(opcionRadioEstudio)) {
                ...
                if ("".equals(mBCliente.getNumeroDoccliente1()) || mBCliente.getNumeroDoccliente1() == null) {
                    mbTodero.setMens("No se ha ingresado ningún cliente");
                    mbTodero.warn();
                    //Valida que exista un bien seleccionado                 
                } else if (mBAvaluo.getSelectPredios().isEmpty() && mBAvaluo.getSelectMaquinaria().isEmpty() && mBAvaluo.getSelectEnseres().isEmpty() && mBAvaluo.getCodTipAvaluo() != 0) {
//                    mbTodero.setMens("No se ha seleccionado ningun bien");
//                    mbTodero.warn();  
                    ...
                    if (Dat.next()) {
                        ...
                        mbTodero.setMens(mBArchivo.GenerarReporte(1, "EstudioPreRadicaSinBien", "Estudio de pre-radicación N° " + cod_preRadica, parametros, event));
                        mbTodero.info();
                    } else {
                    ...
                    if (Dat.next()) {
                        mBArchivo.setNAvaluo(Integer.parseInt(cod_preRadica));
                        mbTodero.setMens(mBArchivo.GenerarReporte(1, "EstudioPreRadica", "Estudio de pre-radicación N° " + cod_preRadica, parametros, event));
                        mbTodero.info();
                    } else {
                        mbTodero.setMens("No se tiene información sobre el cliente ingresado");
                        mbTodero.info();
