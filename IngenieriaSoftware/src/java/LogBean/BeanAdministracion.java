...
public class BeanAdministracion {
    ...
    public void regisRecordator() {
        try {
            ...
            if ("".equals(this.nombreRecordatori)) {
                ...
                AdmRegistroRecord.InsertarRecordatorio(mBsesion.codigoMiSesion(), Prmtro);
                codRecordato = 0;
                nombreRecordatori = "";
                mbTodero.setMens("Registro creado correctamente");
                mbTodero.info();
    ...
    public ArrayList<SelectItem> OnReteica() {
        try {
            Iterator<LogAdministracion> Ite;
            Ite = Adm.CargarImpuestos("ica").iterator();
            while (Ite.hasNext()) {
                LogAdministracion MBAdm = Ite.next();
    ...
    //Cargar Reteica Modulo Factutracion / pestaña Datos  economicos
    public ArrayList<SelectItem> OnReteiva() {
        try {
            Iterator<LogAdministracion> Ite;
            Ite = Adm.CargarImpuestos("teiva").iterator();
            while (Ite.hasNext()) {
                LogAdministracion MBAdm = Ite.next();
    ...
    public ArrayList<SelectItem> OnRetefuente() {
        try {
            Iterator<LogAdministracion> Ite;
            Ite = Adm.CargarImpuestos("fuente").iterator();
            while (Ite.hasNext()) {
                LogAdministracion MBAdm = Ite.next();
